...
Shader "Custom/Ray Casting" {
	...
	Properties {
		...
		//_DataChannelIntensity ("Data Channel", Color) = (1,1,1,1) // in which channel were the data value stored?

		_DataChannelIntensityR("Data Channel Intensity Color Red", Range(0,1)) = 1
		_DataChannelIntensityG("Data Channel Intensity Color Green", Range(0,1)) = 1
		_DataChannelIntensityB("Data Channel Intensity Color Blue", Range(0,1)) = 1
		_DataChannelIntensityA("Data Channel Intensity Color Alpha", Range(0,1)) = 1
	...
	SubShader {
		...
		Pass {
			...
			sampler3D _Data;
			//float4 _DataChannelIntensity;
			float _DataChannelIntensityR;
			float _DataChannelIntensityG;
			float _DataChannelIntensityB;
			float _DataChannelIntensityA;
			float3 _Axis;
			float3 _TexFilling;
			...
			float4 get_data(float3 pos) {
				...
				// colourize
				//float4 col = float4(_DataChannelIntensity.r * data4.r, _DataChannelIntensity.g * data4.g, _DataChannelIntensity.b * data4.b, _DataChannelIntensity.a * data);
				float4 col = float4(_DataChannelIntensityR * data4.r, _DataChannelIntensityG * data4.g, _DataChannelIntensityB * data4.b, _DataChannelIntensityA * data);
				return col;
			}
