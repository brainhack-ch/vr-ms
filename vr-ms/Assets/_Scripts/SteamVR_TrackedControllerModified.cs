...
public class SteamVR_TrackedControllerModified : MonoBehaviour
{
    public uint controllerIndex;
    public VRControllerState_t controllerState;
    public bool triggerPressed = false;
    public bool steamPressed = false;
    public bool menuPressed = false; // Button B - Y
    public bool menuAPressed = false; // Button A - X
    ...
    public event ClickedEventHandler MenuAButtonUnclicked;
    ...
    public virtual void OnMenuAClicked(ClickedEventArgs e)
    {
        if (MenuButtonClicked != null)
            MenuButtonClicked(this, e);
    }

    public virtual void OnMenuAUnclicked(ClickedEventArgs e)
    {
        if (MenuAButtonUnclicked != null)
            MenuAButtonUnclicked(this, e);
    }
    ...
    protected virtual void Update()
    {
        ...
        if (system != null && system.GetControllerState(controllerIndex, ref controllerState, (uint)System.Runtime.InteropServices.Marshal.SizeOf(typeof(VRControllerState_t))))
        {
            ...
            ulong menuA = controllerState.ulButtonPressed & (1UL << ((int)EVRButtonId.k_EButton_A));
            if (menuA > 0L && !menuPressed)
            {
                menuAPressed = true;
                ClickedEventArgs e;
                e.controllerIndex = controllerIndex;
